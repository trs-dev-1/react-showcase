  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex h-full min-h-svh w-full flex-col",
          className
        )}
        {...props}
      >
...
type SidebarProps = React.ComponentProps<typeof Button> & {
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      ...
      {!!notificationsCount && (
        <Badge className="border-background absolute -top-0.5 -right-0.5 flex size-4 items-center justify-center p-2" size="lg">
          {notificationsCount}
        </Badge>
      )}
    </Button>
